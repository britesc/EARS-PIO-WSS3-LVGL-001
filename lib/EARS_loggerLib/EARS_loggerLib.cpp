...
/**
 * @brief Get reference to global errors instance (Singleton pattern)
 * 
 * This function implements the singleton pattern to ensure only one
 * errors instance exists throughout the application lifecycle.
 * 
 * @return EARS_errors& Reference to the global errors instance
 */
EARS_errors& using_errors() {
    static EARS_errors instance;
    return instance;
}
