...
#define XTENSA_COMPILER_MAJOR 8
#define XTENSA_COMPILER_MINOR 4
#define XTENSA_COMPILER_PATCH 0

// Espressif Platform Version (espressif32)
#define ESPRESSIF_PLATFORM_VERSION "6.8.1"
#define ESPRESSIF_PLATFORM_MAJOR 6
